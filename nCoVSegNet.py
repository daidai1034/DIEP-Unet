...
from models.module.ECAresnet import *
...
class DAF(nn.Module):
    def __init__(self, channels_high, channels_low, kernel_size=3, upsample=True):
        ...
        if upsample:
            ...
            self.conv_upsample_2 = nn.ConvTranspose2d(channels_high, channels_low, kernel_size=4, stride=2, padding=1, bias=False)
...
class nCoVSegNet(nn.Module):
    ...
    def forward(self, x):
        ...
        map_1 = self.conv1_1(x1)#[4,1,56,56]
        map_2 = self.conv1_2(x2)#[4, 1, 28, 28]
        map_3 = self.conv1_3(x3)#[4, 1, 14, 14]
        map_4 = self.conv1_4(x4_gca)#[4, 1, 7, 7]
