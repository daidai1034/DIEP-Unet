...
class UNet(nn.Module):
    def __init__(self, in_ch=1, out_ch=1):
        ...
        self.conv0_1 = conv1x1(in_ch, filters[0])
        self.conv0_2 = conv1x1(in_ch, filters[1])
        self.conv0_3 = conv1x1(in_ch, filters[2])
        self.conv0_4 = conv1x1(in_ch, filters[3])
