...
class UNet(nn.Module):
    def __init__(self, in_ch=1, out_ch=1):
        ...
        self.conv1 = RCDB(in_ch, filters[0])
        self.pool1 = nn.MaxPool2d(2)


        self.M1 = MSIE(in_ch, filters[0])
        self.conv2 = RCDB(filters[0], filters[1])
        self.pool2 = nn.MaxPool2d(2)

        self.M2 = MSIE(in_ch, filters[1])
        self.conv3 = RCDB(filters[1], filters[2])
        self.pool3 = nn.MaxPool2d(2)

        self.M3 = MSIE(in_ch, filters[2])
        self.conv4 = RCDB(filters[2], filters[3])
        self.pool4 = nn.MaxPool2d(2)

        self.M4 = MSIE(in_ch, filters[3])
        self.conv5 = RCDB(filters[3], filters[4])
        ...
        # decoder
        self.conv6 = RCB(filters[4], filters[3])
        self.conv7 = RCB(filters[3], filters[2])
        self.conv8 = RCB(filters[2], filters[1])
        self.conv9 = RCB(filters[1], filters[0])
